...
export default class HiHat implements InstrumentEngine {
  private ctx: AudioContext;
  private ratios: number[];
  public tone: number;
  public decay: number;
  private oscEnvelope: GainNode | undefined;
  private bndPass: BiquadFilterNode | undefined;
  private hipass: BiquadFilterNode | undefined;
  ...
  trigger(time: number) {
    ...
    this.ratios.forEach((ratio) => {
      ...
      if (this.bndPass) osc.connect(this.bndPass);
